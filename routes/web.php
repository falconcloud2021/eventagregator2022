...
Route::middleware(['auth:sanctum', 'verified'])->group(function () {
    ...
    Route::group(['as' => 'parser.', 'prefix' => 'parser'], function () {
        ...
        Route::get('/edit/{parser}', [ParserController::class, 'edit'])->name('edit');
        Route::patch('/{parser}', [ParserController::class, 'update'])->name('update');
        Route::delete('/{parser}', [ParserController::class, 'destroy'])->name('destroy');
    });
    // 4. Widgets methods:
